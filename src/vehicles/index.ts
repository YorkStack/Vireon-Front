...
const ALL: VehicleVariant[] = [
  ...
  redMediumTank, redHeavyTank, redAntiAir, redSupport,
  blueHarvester, blueBuilder, blueScout, blueLightAttack,
  blueMediumTank, blueHeavyTank, blueAntiAir, blueSupport,
  greenHarvester, greenBuilder, greenScout, greenLightAttack,
  greenMediumTank, greenHeavyTank, greenAntiAir, greenSupport,
  yellowHarvester, yellowBuilder, yellowScout, yellowLightAttack,
  yellowMediumTank, yellowHeavyTank, yellowAntiAir, yellowSupport,
];
