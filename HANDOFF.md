...
## 🏭 Teilprojekt C — Vehicle Component Factory (in Arbeit, 2026-06-14)
...
- **OFFEN:** Task 3 Component/Assembly-Spec+Validator (TS, gegen REGISTRY), Task 5 Spiel-GLB-Render-Pfad (loadVehicleGlb, accent-Tint, turret-Node an Animator, Fallback-Warn), Task 6 Muzzle-Effekt E2E, Task 7 Verifikation auf 5199.
