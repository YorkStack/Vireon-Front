...
- **OFFEN:** Task 2 Crimson-Templates (chassis/track/turret/weapon/sensor), Task 3 Component/Assembly-Spec+Validator, Task 4 assemble.py+bake.py→Runtime-GLB, Task 5 Spiel-GLB-Render-Pfad, Task 6 Muzzle-Effekt E2E, Task 7 Verifikation.
