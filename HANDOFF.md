...
- **OFFEN:** Fraktion/Klasse-Tabs im Selektor (aktuell red-fix), **Textur-Bibliothek** (Preset-Schema target×faction×style + Picker + texGroup→metadata→Spiel + erstes Reifen-Set + exotische Geometrie-Templates), dann Beine/Hover/Monowheel. Tests: Studio **22**, Spiel **57** grün.
